...
table = hp.parse_url(url)[6][1]
#isq=table[6][1].dropna(axis=1)
#newnames=list(table[6][1].columns)[0:13]
...
url = "https://www.fantasypros.com/nfl/reports/leaders/qb.php?year=2015"
hp = HTMLTableParser()
tablefan = hp.parse_url(url)[0][1]#Grabbing the table from the tuple
tablefan
